...
class _$ProductsRecord extends ProductsRecord {
  ...
  @override
  final BuiltList<String>? productImage;
  @override
  final String? brand;
  @override
...
class ProductsRecordBuilder
  ...
  ListBuilder<String>? _productImage;
  ListBuilder<String> get productImage =>
      _$this._productImage ??= new ListBuilder<String>();
  set productImage(ListBuilder<String>? productImage) =>
