...
export 'baseball_model.dart';

class BaseballWidget extends StatefulWidget {
  const BaseballWidget({Key? key}) : super(key: key);

  @override
  _BaseballWidgetState createState() => _BaseballWidgetState();
}
...
class _BaseballWidgetState extends State<BaseballWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BaseballModel());
