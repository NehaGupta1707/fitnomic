...
class Yoga1Widget extends StatefulWidget {
  const Yoga1Widget({Key? key}) : super(key: key);

  @override
  _Yoga1WidgetState createState() => _Yoga1WidgetState();
}
                          ...
                          children: [
                            Padding(
                              ...
                              child: FlutterFlowYoutubePlayer(
                                url: 'https://youtu.be/XckHbKSmVCk',
                                autoPlay: false,
                                looping: true,
                                mute: false,
                                showControls: true,
                              ...
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 4.0, 0.0, 4.0),
                                  child: Text(
                                    'Welcome to our beginner\'s yoga part 1 video! This yoga practice is designed for those who are new to yoga and want to learn the basics of yoga practice.\n\nIn this video, you will be guided through a series of simple and foundational yoga poses that are easy to follow and safe to do at home. Each pose is demonstrated by a certified yoga instructor and accompanied by clear and concise instructions, making it simple for you to understand and practice.\n\nThe video is gentle and welcoming, with an emphasis on proper alignment and breathing techniques. You will be encouraged to move your body in a mindful and intentional way, helping you to connect with your breath and cultivate a sense of inner calm.\nBy the end of the video, you will have completed a full yoga routine that will leave you feeling energized and refreshed. You will have learned new yoga poses, breathing techniques, and mindfulness practices that you can use in your daily life to improve your overall well-being.\n\nSo, whether you are completely new to yoga or just looking to refresh your practice, join us for this fun and accessible beginner\'s yoga part 1 video!',
                                    textAlign: TextAlign.start,
                                    style:
