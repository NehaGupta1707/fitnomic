...
import 'basketball_model.dart';
export 'basketball_model.dart';

class BasketballWidget extends StatefulWidget {
  const BasketballWidget({Key? key}) : super(key: key);

  @override
  _BasketballWidgetState createState() => _BasketballWidgetState();
}

class _BasketballWidgetState extends State<BasketballWidget> {
  late BasketballModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BasketballModel());
