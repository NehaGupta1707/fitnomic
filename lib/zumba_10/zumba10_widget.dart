...
import 'zumba10_model.dart';
export 'zumba10_model.dart';

class Zumba10Widget extends StatefulWidget {
  const Zumba10Widget({Key? key}) : super(key: key);

  @override
  _Zumba10WidgetState createState() => _Zumba10WidgetState();
}

class _Zumba10WidgetState extends State<Zumba10Widget> {
  late Zumba10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Zumba10Model());
                          ...
                          children: [
                            Padding(
                              ...
                              child: FlutterFlowYoutubePlayer(
                                url: 'https://youtu.be/9gmcfWEBynk',
                                autoPlay: false,
                                looping: true,
                                mute: false,
                                showControls: true,
