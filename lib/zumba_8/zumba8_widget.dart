...
import 'zumba8_model.dart';
export 'zumba8_model.dart';

class Zumba8Widget extends StatefulWidget {
  const Zumba8Widget({Key? key}) : super(key: key);

  @override
  _Zumba8WidgetState createState() => _Zumba8WidgetState();
}

class _Zumba8WidgetState extends State<Zumba8Widget> {
  late Zumba8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Zumba8Model());
                          ...
                          children: [
                            Padding(
                              ...
                              child: FlutterFlowYoutubePlayer(
                                url: 'https://youtu.be/izUh4Y4rQN0',
                                autoPlay: false,
                                looping: true,
                                mute: false,
                                showControls: true,
