...
import 'yoga11_model.dart';
export 'yoga11_model.dart';

class Yoga11Widget extends StatefulWidget {
  const Yoga11Widget({Key? key}) : super(key: key);

  @override
  _Yoga11WidgetState createState() => _Yoga11WidgetState();
}

class _Yoga11WidgetState extends State<Yoga11Widget> {
  late Yoga11Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Yoga11Model());
                          ...
                          children: [
                            Padding(
                              ...
                              child: FlutterFlowYoutubePlayer(
                                url: 'https://youtu.be/iUs9RVc7A2M',
                                autoPlay: false,
                                looping: true,
                                mute: false,
                                showControls: true,
